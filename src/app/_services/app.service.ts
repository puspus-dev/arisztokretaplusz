...
export class AppService {
    ...
    public set currentLng(newLng: string) {
        ...
        import(`@angular/common/locales/${newLng}.js`).then(module =>
    ...
    public async downloadUserAgent() {
        ...
        try {
            let result = await this.http.get(
                "https://raw.githubusercontent.com/Coware-Apps/ellenorzo/master/docs/config.json",
                null,
                null
            );
    ...
    public getBackButtonText(): string | null {
        return this.platform.is("ios") ? this.translator.instant("common.back") : null;
    }
}
